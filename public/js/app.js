...
/* harmony import */ var _splideNum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./splideNum */ "./resources/js/splideNum.js");
/* harmony import */ var _splide2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./splide2 */ "./resources/js/splide2.js");
/* harmony import */ var _map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./map */ "./resources/js/map.js");
/* harmony import */ var _burger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./burger */ "./resources/js/burger.js");
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./popup */ "./resources/js/popup.js");
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sliders */ "./resources/js/sliders.js");
/* harmony import */ var _scrollGsap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./scrollGsap */ "./resources/js/scrollGsap.js");
/* harmony import */ var _gsapAnimation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./gsapAnimation */ "./resources/js/gsapAnimation.js");
...
var start = function start() {
  ...
  (0,_sliders__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_scrollGsap__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_gsapAnimation__WEBPACK_IMPORTED_MODULE_9__["default"])();
  ...
  // menu.open();
  (0,_splide2__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_map__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
var burgerOn = function burgerOn() {
  var popup = document.querySelector(".burger");
  try {
    popup.querySelector(".burger-cont").onclick = function (e) {
      e.stopPropagation();
    };
  ...
  var burgerA = document.querySelectorAll(".burger-on");
  var burgerBlock = document.querySelectorAll(".burger");
  try {
...
/* harmony default export */ __webpack_exports__["default"] = (burgerOn);
...
var accordionInit = function accordionInit() {
  var accordions = document.querySelectorAll("._accordion");
  accordions.forEach(function (accordion) {
    var head = accordion.querySelector("._accordion__head");
    var body = accordion.querySelector("._accordion__body");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordion */ "./resources/js/components/accordion.js");

var componentsInit = function componentsInit() {
  (0,_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])();
};
/* harmony default export */ __webpack_exports__["default"] = (componentsInit);

/***/ }),

/***/ "./resources/js/gsapAnimation.js":
/*!***************************************!*\
  !*** ./resources/js/gsapAnimation.js ***!
  \***************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var gsapAnimation = function gsapAnimation() {
  var mm = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.matchMedia();
  document.querySelectorAll(".solution-card").forEach(function (link) {
    var cardBg = link.querySelector(".solution-card__bg");
    var arrBg = link.querySelector(".open__arr");
    var openArrGrey = link.querySelector(".open__arrGrey");
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(cardBg, {
      yPercent: 130
    });
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(arrBg, {
      scaleX: 0,
      scaleY: 0
    });
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(openArrGrey, {
      scaleX: 1,
      scaleY: 1
    });
    link.addEventListener("mouseenter", function () {
      mm.add("(min-width: 1px)", function () {
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(link, {
          height: '400px',
          duration: 1,
          ease: "power2.out"
        });
...
/* harmony default export */ __webpack_exports__["default"] = (gsapAnimation);
...
var mapInit = function mapInit() {
  ymaps.ready(function () {
    ...
    var myPlacemarkWithContent = new ymaps.Placemark([59.937130834238324, 30.31199301854456], {}, {
      // Опции.
...
var popupInit = function popupInit() {
  var popups = document.querySelectorAll("._popup");
  try {
    popups.forEach(function (popup) {
      popup.querySelector("._popup__content").onclick = function (e) {
        e.stopPropagation();
      };
      popup.onclick = function () {
        popup.classList.add("hidden");
...
/* harmony default export */ __webpack_exports__["default"] = (popupInit);

/***/ }),

/***/ "./resources/js/scrollGsap.js":
/*!************************************!*\
  !*** ./resources/js/scrollGsap.js ***!
  \************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var scrollGsap = function scrollGsap() {
  var container = document.querySelector(".section-solutions");
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(ScrollTrigger);
  var sections = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".solution-card");
  var mm = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.matchMedia();
  mm.add("(min-width: 769px)", function () {
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(sections, {
      x: function x() {
        return -(container.scrollWidth - document.documentElement.clientWidth + 350) + "px";
      },
      ease: "none",
      duration: 5,
      scrollTrigger: {
...
/* harmony default export */ __webpack_exports__["default"] = (scrollGsap);
...
var slidersInit = function slidersInit() {
  var splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#image-carousel', {
    perPage: 3,
    type: 'loop',
    rewind: true,
    cloneStatus: false,
  ...
  splide.on('moved', function () {
    mm.add("(min-width: 770px)", function () {
      var card = document.querySelector("#image-carousel .splide__slide.is-prev");
      // const cardActive= document.querySelector("#image-carousel .splide__slide.is-active");
      var cardNext = document.querySelector("#image-carousel .splide__slide.is-next");
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from(card, {
        x: 40
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from(cardNext, {
        x: -40
        // xPercent: -10,
        //
        // duration: 1,
  ...
  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#slider3', {
    perPage: 7,
    type: 'loop',
    gap: 18,
    padding: {
  ...
  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#slider4', {
    perPage: 7,
    type: 'loop',
    gap: 18,
    padding: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _splideNum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./splideNum */ "./resources/js/splideNum.js");
...
var sliders2Init = function sliders2Init() {
  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"]('#slider2', {
    type: 'loop',
    padding: '12.5%',
    gap: 60,
    speed: 600,
    ...
    SlideNumber: _splideNum__WEBPACK_IMPORTED_MODULE_0__.SlideNumber
  });
};
/* harmony default export */ __webpack_exports__["default"] = (sliders2Init);

/***/ }),

/***/ "./resources/js/splideNum.js":
/*!***********************************!*\
  !*** ./resources/js/splideNum.js ***!
  \***********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SlideNumber: function() { return /* binding */ SlideNumber; }
/* harmony export */ });
function SlideNumber(Splide, Components) {
  ...
  function update() {
    elm.textContent = "".concat(Splide.index + 1);
    elm2.textContent = "".concat(Splide.length);
  }
  return {
    mount: mount
  };
...
/* harmony default export */ __webpack_exports__["default"] = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_splide_core_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
