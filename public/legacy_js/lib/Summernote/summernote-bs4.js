...
var dialog = renderer["a" /* default */].create('<div class="dialog note-dialog" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="dialog-dialog">', '<div class="dialog-content">', options.title ? '<div class="dialog-header">' + '<h4 class="dialog-title">' + options.title + '</h4>' + '<button type="button" class="close" data-dismiss="dialog" aria-label="Close" aria-hidden="true">&times;</button>' + '</div>' : '', '<div class="dialog-body">' + options.body + '</div>', options.footer ? '<div class="dialog-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
});
